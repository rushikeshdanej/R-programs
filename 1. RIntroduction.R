...
# c means combine of conctenate the data
class(mix)  
...
sample(1:10,20,replace=TRUE) # 20 is the range
...
x
x[-1] # exclude 1st element 1st element is gone

x[-2] # exclude 2nd element 2nd element is gone
x
x[-4]
x[c(-1,-4)]
x
...
help(paste) # paste is a function
